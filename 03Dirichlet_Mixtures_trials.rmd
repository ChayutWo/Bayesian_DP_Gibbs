...
---
title: "Multinomial Mixture Model (Multiple trials)"
output:
...
- For each k, there are three possible outcomes J = 6 ($\theta_k$ denotes multinomial parameters for cluster k and $\theta_{kj}$ denotes the probability of having outcome j in cluster k). We have 10 trials per sampling.
...
$x_i \mid z_i = k, \theta_k \sim Mult(10, \theta_k)$
...
```{r}
matplot(1:dim(sample_pmf)[1], sample_pi, type = 'l', 
        ylab = 'Prob', xlab = 'trials', 
