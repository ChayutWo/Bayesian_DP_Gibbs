...
X1: Continuous variable which we will generate from $Unif(0, 3)$
...
- There will be data missing at random (MAR) in Y. The probability of missingness is govern by $logit(w_1^Tx_{i1} + w_2^Tx_{i2} -1)$ where $w_1 = -0.1$ and $w_2 = [-0.1, -0.1, -0.1]$. This results in 24% of missing data in the last feature.
