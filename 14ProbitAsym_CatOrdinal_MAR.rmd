...
---
title: "Probit regression for ordinal data (Asymmetric): MAR"
output:
...
The proportion of members in each ordered category will be asymmetric. Specifically, the percent of each group will be 10%, 20%, 40%, 15%, and 15% respectively.
...
g = quantile(Z, probs = c(0.1, 0.3, 0.7, 0.85))
Y = rep(NA, n)
Y[Z<g[1]] = 1
Y[Z>=g[1] & Z<g[2]] = 2
Y[Z>=g[2] & Z<g[3]] = 3
